...
INSERT INTO `nodes_access` VALUES (1,1,1,2),(2,2,1,2),(3,3,1,2),(4,4,1,2),(5,5,1,2),(6,6,1,2),(7,7,1,2),(8,8,1,2),(10,10,1,2),(11,11,1,2),(12,12,1,2),(14,14,1,2),(15,15,1,2),(16,16,1,2),(17,13,1,2),(18,17,1,2);
...
INSERT INTO `nodes_admin` VALUES (1,'Access','access','cms/access.jpg'),(2,'Pages','pages','cms/pages.jpg'),(3,'Content','content','cms/content.jpg'),(4,'Products','products','cms/products.jpg'),(5,'Users','users','cms/users.jpg'),(6,'Panoramas','panoramas','cms/panorama.jpg'),(7,'Finance','finance','cms/finance.jpg'),(8,'Language','language','cms/language.jpg'),(10,'Files','files','cms/files.jpg'),(11,'Config','config','cms/config.jpg'),(12,'Backend','backend','cms/backend.jpg'),(14,'Perfomance','perfomance','cms/perfomance.jpg'),(15,'Outbox','outbox','cms/outbox.jpg'),(16,'Errors','errors','cms/errors.jpg'),(13,'Attendance','attendance','cms/attendance.jpg'),(17,'Exceptions','exceptions','cms/exceptions.jpg');
/*!40000 ALTER TABLE `nodes_admin` ENABLE KEYS */;
UNLOCK TABLES;
DROP TABLE IF EXISTS `nodes_attendance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nodes_attendance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  KEY `token` (`token`),
  KEY `display` (`display`)
) ENGINE=MyISAM AUTO_INCREMENT=39236 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nodes_cache` (
  ...
  KEY `lang` (`lang`)
) ENGINE=MyISAM AUTO_INCREMENT=16069 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nodes_config` VALUES (1,'name','DAO Mansion','Site name','string'),(2,'description','Incorporating the concept of Web 3.0 information society, the DAO aims to create a progressive and sustainable community that combines ecological, social, and economic benefits.','Description','string'),(3,'email','devbyzero@yandex.ru','Site email','string'),(4,'language','ru','Site language','string'),(5,'languages','en;ru;zh','Available languages','string'),(6,'image','https://dao-mansion.ru/img/preview.jpg','Site image','string'),(7,'email_image','https://dao-mansion.ru/img/preview.jpg','Email header image','string'),(8,'invoice_image','https://dao-mansion.ru/img/preview.jpg','Invoice logo image','string'),(9,'template','bootstrap','Template','string'),(10,'default','profile.php','System','string'),(11,'debug','0','Debug mode','bool'),(12,'cron','0','jQuery cron','bool'),(13,'cache','1','Allow cache','bool'),(14,'compress','1','Compress HTML','bool'),(15,'sandbox','1','Sandbox payment mode','bool'),(20,'free_message','0','Messages between users','bool'),(21,'daily_report','1','Daily report to email','bool'),(22,'confirm_signup_email','1','Email confirmation on sign up','bool'),(23,'send_comments_email','1','Email admin on comment','bool'),(24,'send_registration_email','1','Email user on sign up','bool'),(25,'send_message_email','1','Email user on message','bool'),(26,'send_paypal_email','1','Email user on payment','bool'),(27,'git','http://git.dao-mansion.ru:3000/restinpc/DAO','Git repository URL','string'),(61,'cron_sessions','1724396761','System','int'),(30,'yandex_money','','<a href=\"https://money.yandex.ru/\" target=\"_blank\">Yandex Money ID</a>','string'),(31,'paypal_test','1','PayPal test mode','bool'),(32,'paypal_id','','<a href=\"https://www.paypal.com/\" target=\"_blank\">PayPal user ID</a>','string'),(33,'payment_description','','Payment description','string'),(51,'outbox_limit','1','Max outbox per minute','int'),(52,'version','8','System','int'),(55,'cron_images','1724396642','System','int'),(56,'cron_exec','1724425261','System','int'),(57,'cron_done','1724425261','System','int'),(58,'lastreport','1724356801','System','int'),(62,'timezone','Europe/Moscow','Timezone','string'),(63,'telegram_url','community_v3','Telegram group link','string'),(64,'telegram_name','Web 3.0 Community','Telegram group name','string'),(65,'token_limit','20','Max requests per minute','int'),(66,'ip_limit','20','Max requests per minute (ip)','int'),(67,'exceptions_handler','https://pool.loadest.nodes-studio.com:2342','Black Box URL','string');
...
DROP TABLE IF EXISTS `nodes_exception`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nodes_exception` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `url` varchar(400) NOT NULL,
  `name` varchar(40) NOT NULL,
...
DROP TABLE IF EXISTS `nodes_finance_command`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nodes_finance_command` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `nodes_finance_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nodes_finance_data` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  ...
  `bch` double NOT NULL DEFAULT '0',
  `bch-local` double NOT NULL DEFAULT '0',
  `eth` double NOT NULL DEFAULT '0',
  `usdt` double NOT NULL DEFAULT '0',
  `xch` double NOT NULL DEFAULT '0',
...
DROP TABLE IF EXISTS `nodes_finance_node`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nodes_finance_node` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(64) NOT NULL,
  `ip` varchar(64) NOT NULL,
  `date` datetime NOT NULL,
  `btcDate` datetime DEFAULT NULL,
  `bchDate` datetime DEFAULT NULL,
  `bnbDate` datetime DEFAULT NULL,
  `btcDelay` int(11) DEFAULT '0',
  `bchDelay` int(11) DEFAULT '0',
  `bnbDelay` int(11) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

DROP TABLE IF EXISTS `nodes_finance_prop`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nodes_finance_prop` (
  `name` varchar(40) NOT NULL,
  `value` text NOT NULL,
  PRIMARY KEY (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
LOCK TABLES `nodes_finance_prop` WRITE;
/*!40000 ALTER TABLE `nodes_finance_prop` DISABLE KEYS */;
INSERT INTO `nodes_finance_prop` VALUES ('btcLastUpdate','2023-05-03 11:34:02'),('bchLastUpdate','2023-05-03 07:59:06'),('bnbLastUpdate','2024-08-23 16:56:04');
/*!40000 ALTER TABLE `nodes_finance_prop` ENABLE KEYS */;
UNLOCK TABLES;
DROP TABLE IF EXISTS `nodes_finance_rate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nodes_finance_rate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `usd` double NOT NULL DEFAULT '0',
  `eur` double NOT NULL DEFAULT '0',
  `btc` double NOT NULL DEFAULT '0',
  ...
  `eth` double NOT NULL DEFAULT '0',
  `xch` double NOT NULL DEFAULT '0',
  `bnb` double NOT NULL DEFAULT '0',
  `date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=19701 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

DROP TABLE IF EXISTS `nodes_finance_transaction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nodes_finance_transaction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `chain` varchar(6) NOT NULL,
...
DROP TABLE IF EXISTS `nodes_finance_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nodes_finance_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `sid_expire` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

DROP TABLE IF EXISTS `nodes_handler`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `nodes_handler` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `nodes_perfomance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `server_time` float NOT NULL,
  `script_time` float NOT NULL,
  `cache_id` int(11) NOT NULL DEFAULT '0',
  `date` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3974 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `nodes_relations` VALUES (2,1,30,1,2147483647);
