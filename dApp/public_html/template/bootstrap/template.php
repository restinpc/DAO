...
if (empty($_SESSION["user"]["id"])) {
    $header .= '<li>
                    <a target="_parent" id="b1" hreflang="'.$_SESSION["Lang"].'" href="' .engine::href(''.$_SERVER["DIR"].'/signup'). '" class="btn btn-round">
                        <noindex class="material-icons">person_add</noindex> '.engine::lang("Sign Up").'
                    </a>
                </li>
                <li>
                    <a target="_parent" id="b2" hreflang="'.$_SESSION["Lang"].'" href="' .engine::href(''.$_SERVER["DIR"].'/login'). '" class="btn btn-round">
                        <noindex class="material-icons">account_circle</noindex> '.engine::lang("Login").'
                    </a>
                </li>
                ';
} else {
    if ($_SESSION["user"]["admin"] != 1) {
        $header .= '<li>
                    <a hreflang="'.$_SESSION["Lang"].'" href="' .engine::href($_SERVER["DIR"].'/account'). '"  onClick="hide_menu();"  id="b1" class="btn btn-round">
                        <noindex class="material-icons">person</noindex> '.engine::lang("Account").'
                    </a>
                </li>';
    } else {
        $header .= '<li>
                    <a hreflang="'.$_SESSION["Lang"].'" href="' .engine::href($_SERVER["DIR"].'/admin'). '"  onClick="hide_menu(); js_hide_wnd();"  id="b1" class="btn btn-round">
                        <noindex class="material-icons">person</noindex> '.engine::lang("Admin").'
                    </a>
                </li>';
    }
    $header .= '
                <li>
                    <a target="_parent" id="b2"  onClick="hide_menu(); logout();" class="btn btn-round">
                        <noindex class="material-icons">directions_run</noindex> '.engine::lang("Logout").'
                    </a>
                </li>
                ';
    if ($_SERVER["app"]=="TRUE") {
            $header .= '
                <li>
                    <a target="_top" id="b3" onClick=\'window.location = "/#close";\' class="btn btn-round">
                        <noindex class="material-icons">close</noindex> '.engine::lang("Close Application").'
                    </a>
                </li>
                ';
    }
