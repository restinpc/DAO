...
function print_social_navigation($current){
    $arr = [
        lang("Social graph") => $_SERVER["DIR"]."/social/graph",
        lang("Telegram group") => $_SERVER["DIR"]."/social/telegram",
        lang("Digital constitution") => $_SERVER["DIR"]."/social/constitution",
        lang("Crypto democracy") => $_SERVER["DIR"]."/social/democracy",
        lang("Crowdfunding") => $_SERVER["DIR"]."/social/crowdfunding"
    ];
