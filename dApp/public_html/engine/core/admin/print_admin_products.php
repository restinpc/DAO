...
function print_admin_products($cms){
    ...
    if($_GET["action"]=="add"){
        ...
        if(empty($_SESSION["photos"])){
            $fout = '
                ...
                <form method="POST">';
                    ...
                    <input vr-control type="button" id="upload_btn" value="'.lang("Upload new image").'" class="btn w280"  onClick=\'show_photo_editor(0,0);\' /><br/><br/><br/>
                    <input type="hidden" name="product" value="1" />
                <div class="add_product_left">
                    '.lang("Please, describe this item").'<br/><br/>
                    <input vr-control id="product-title" type="text" placeHolder="'.lang("Title").'" class="input w280" name="title" required /><br/><br/>
                    <textarea vr-control id="textarea-description" class="input w280 h100" name="text" placeHolder="'.lang("Description (e.g. Blue Nike Vapor Cleats Size 10. Very comfortable and strong ankle support.)").'" required></textarea><br/><br/>
                    <input vr-control id="product-price" type="text" class="input w280" name="price" placeHolder="$ 0.00" required /><br/><br/>';
                $query = 'SELECT * FROM `nodes_product_property` ORDER BY `id` ASC';
                $res = engine::mysql($query);
                while($data=  mysqli_fetch_array($res)){
                    $flag = 0;
                    $select = '<select vr-control id="select-product-data-'.$data["id"].'" class="input w280" style="margin-bottom: 15px;" name="property_'.$data["id"].'" onChange=\'if(this.value=="-1"){document.getElementById("new_value_'.$data["id"].'").style.display="block"; jQuery("#new_value_'.$data["id"].'").removeClass("hidden"); this.style.display="none";}\'>'
                    . '<option vr-control id="option-product-data-'.$data["id"].'-0" disabled selected>'.$data["value"].'</option>';
                    $query = 'SELECT * FROM `nodes_product_data` WHERE `cat_id` = "'.$data["id"].'"';
                    $r = engine::mysql($query);
                    while($d = mysqli_fetch_array($r)){
                        $flag = 1;
                        $select .= '<option vr-control id="option-product-data-'.$data["id"].'-'.$d["id"].'" value="'.$d["id"].'">'.$d["value"].'</option>';
                    }$select .= '
                        <option vr-control id="option-product-data-'.$data["id"].'-1" value="-1">'.lang("New value").'</option>
                        </select><input vr-control id="product-value-'.$data["id"].'-'.$d["id"].'" type="text" class="input w280" style="display:none; margin: 0px auto;" name="new_value_'.$data["id"].'" id="new_value_'.$data["id"].'" placeHolder="'.$data["value"].'" />
                        <br/>';
                    if($flag){
                        $fout .= $select;
                    }
                ...
                $fout .= '
                    <div id="nodes_new_properties">
                        <input vr-control id="product-new-property" type="text" name="new_property" class="input w280" placeHolder="'.lang("Property").'" /><br/><br/>
                        <input vr-control id="product-new-value" type="text" name="new_value" class="input w280" placeHolder="'.lang("Value").'" /><br/>
                    </div>
                    <input vr-control id="product-add-property" type="button" value="'.lang("Add new property").'" class="btn small w280" 
            ...
            $fout .= '
                ...
                <div class="add_product_right">
                    ...
                    <input vr-control id="product-shipping-country" type="text" class="input w280" placeHolder="'.lang("Country").'" id="country_selector" name="country" required value="'.$data["country"].'" /><br/><br/>
                    <input vr-control id="product-shipping-state" type="text" class="input w280" placeHolder="'.lang("State").'" name="state" required value="'.$data["state"].'" /><br/><br/>
                    <input vr-control id="product-shipping-city" type="text" class="input w280" placeHolder="'.lang("City").'" name="city" required value="'.$data["city"].'"  /><br/><br/>
                    <input vr-control id="product-shipping-zip" type="text" class="input w280" placeHolder="'.lang("Zip code").'" name="zip" required value="'.$data["zip"].'"  /><br/><br/>
                    <input vr-control id="product-shipping-street1" type="text" class="input w280" placeHolder="'.lang("Street").' 1" name="street1" required value="'.$data["street1"].'"  /><br/><br/>
                    <input vr-control id="product-shipping-street2" type="text" class="input w280" placeHolder="'.lang("Street").' 2" name="street2" value="'.$data["street2"].'"  /><br/><br/>
                    <input vr-control id="product-shipping-phone" type="text" class="input w280" placeHolder="'.lang("Phone number").'" name="phone" required value="'.$data["phone"].'"  /><br/><br/>
                    <br/>
                </div>
                <div class="clear"><br/></div>
                <div class="w600 m0a">
                    <textarea vr-control id="editable" name="description" placeHolder="'.lang("Complete item description").'"></textarea>
                    <br/><br/>
                </div>
                <input vr-control id="product-shipping-submit" type="submit" class="btn w280" value="'.lang("Submit").'" /><br/>
            </form>
            </div>
        ...
        if(!empty($_GET["id"])){
            ...
            $fout = '<div class="document edit_product">
                ...
                $fout .= '<table align=center><tr>';
                    ...
                    foreach($images as $img){
                        ...
                        if(!empty($img)){
                            ...
                            . '<img vr-control id="img-product-'.$i.'" class="img" src="'.$_SERVER["DIR"].'/img/data/thumb/'.$img.'" onClick=\'select_image("'.$i.'", "'.$img.'");\'/><br/>
                                <div vr-control id="div-product-'.$i.'" class="new_small_photo" onClick=\'show_photo_editor('.$product["id"].', '.$i.');\' > </div>';
                            if($i>1){
                                $fout .= '<input vr-control id="product-delete-'.$product["id"].'"  class="btn small del_button" type="button" value="'.lang("Delete").'" onClick=\'delete_image("'.$product["id"].'", "'.$i.'");\' />';
                            }
                            $fout .= '</td>';
                        }
                    }
                    if($i<4){
                        $fout .= '<td class="add_td">'
                                . '<div vr-control id="div-add-photo-'.$i.'" class="new_add_photo" onClick=\'show_photo_editor('.$product["id"].', '.(++$i).');\' > </div>
                                </td>';
                    }
                $fout .= '</tr>
                </table>
                ...
                <div class="double_column">
                    <section class="double_column_block">
                        <input type="hidden" name="product" value="1" />
                        '.lang("Please, describe this item").'<br/><br/>
                        <input vr-control id="product-edit-title"  type="text" placeHolder="'.lang("Title").'" title="'.lang("Title").'"  class="input w280" name="title" required value="'.$product["title"].'" /><br/><br/>
                        <textarea vr-control id="textarea-desc" class="input w280 h100" name="text" title="'.lang("Description").'" placeHolder="'.lang("Description (e.g. Blue Nike Vapor Cleats Size 10. Very comfortable and strong ankle support.)").'" required>'.$product["text"].'</textarea><br/><br/>'
                        . '<input vr-control id="product-edit-price" type="text" class="input w280" name="price" title="'.lang("Price").'" placeHolder="$ 0.00" required value="'.$product["price"].'" /><br/>
                        <br/>';
                    $query = 'SELECT * FROM `nodes_product_property` ORDER BY `id` ASC';
                    $res = engine::mysql($query);
                    while($fdata=  mysqli_fetch_array($res)){
                        $flag = 0;
                        $fout .= '<select vr-control id="select-product-data-'.$fdata["id"].'" class="input w280" name="property_'.$fdata["id"].'" title="'.$fdata["value"].'" onChange=\'if(this.value=="-1"){document.getElementById("new_value_'.$fdata["id"].'").style.display="block"; jQuery("#new_value_'.$fdata["id"].'").removeClass("hidden"); this.style.display="none";}\' >'
                        ...
                        while($d = mysqli_fetch_array($r)){
                            ...
                            $dd = mysqli_fetch_array($rr);
                            if(!empty($dd)){
                                $fout .= '<option vr-control id="option-product-data-'.$fdata["id"].'-'.$d["id"].'" selected value="'.$d["id"].'">'.$d["value"].'</option>';
                            }else{
                                $fout .= '<option vr-control id="option-product-data-'.$fdata["id"].'-'.$d["id"].'" value="'.$d["id"].'">'.$d["value"].'</option>';
                            }
                        }$fout .= '<option vr-control id="option-product-data-'.$fdata["id"].'-0" value="-1">'.lang("New value").'</option>
                        </select><input vr-control id="product-edit-'.$fdata["id"].'" type="text" class="input w280" style="display:none; margin: 0px auto;" name="new_value_'.$fdata["id"].'" id="new_value_'.$fdata["id"].'" placeHolder="'.$fdata["value"].'" />'
                                . '<br/><br/>';
                    }
                    $fout .= '
                        <div id="nodes_new_properties">
                            <input vr-control id="product-add-new-property" type="text" name="new_property" class="input w280" placeHolder="'.lang("Property").'" /><br/><br/>
                            <input vr-control id="product-add-new-value" type="text" name="new_value" class="input w280" placeHolder="'.lang("Value").'" /><br/>
                        </div>
                        <input vr-control id="product-new-property-button"  type="button" value="'.lang("Add new property").'" class="btn small w280" 
                            onClick=\'document.getElementById("nodes_new_properties").style.display="block";
                            jQuery("#nodes_new_properties").removeClass("hidden");
                            this.style.display="none";\' 
                        /><br/><br/>
                    ...
                    <section class="double_column_block">';
                        ...
                        <input type="hidden" name="shipping" value="1" />
                        <input vr-control id="product-edit-country" type="text" class="input w280" placeHolder="'.lang("Country").'" id="country_selector" name="country" required value="'.$data["country"].'" /><br/><br/>
                        <input vr-control id="product-edit-state" type="text" class="input w280" placeHolder="'.lang("State").'" name="state" required value="'.$data["state"].'" /><br/><br/>
                        <input vr-control id="product-edit-city" type="text" class="input w280" placeHolder="'.lang("City").'" name="city" required value="'.$data["city"].'"  /><br/><br/>
                        <input vr-control id="product-edit-zip" type="text" class="input w280" placeHolder="'.lang("Zip code").'" name="zip" required value="'.$data["zip"].'"  /><br/><br/>
                        <input vr-control id="product-edit-street1" type="text" class="input w280" placeHolder="'.lang("Street").' 1" name="street1" required value="'.$data["street1"].'"  /><br/><br/>
                        <input vr-control id="product-edit-street2" type="text" class="input w280" placeHolder="'.lang("Street").' 2" name="street2" value="'.$data["street2"].'"  /><br/><br/>
                        <input vr-control id="product-edit-phone" type="text" class="input w280" placeHolder="'.lang("Phone number").'" name="phone" required value="'.$data["phone"].'"  /><br/><br/>
                    </section>
                    <div class="clear"></div>
                    <div class="w600 tal">
                        <textarea vr-control class="w100p" id="editable" name="description">'.$product["description"].'</textarea>
                        <br/><br/>
                    </div>
                    <input vr-control id="product-edit-submit" type="submit" class="btn w280" value="'.lang("Save changes").'" /><br/><br/>
                    <a vr-control id="back-to-products" href="'.$_SERVER["DIR"].'/admin/?mode=products"><input type="button" class="btn w280" value="'.lang("Back to products").'" /></a><br/>
                </div>
                </form>
            </div>
            <style>.country-select{width: 280px;}</style>';
            ...
            while($data=mysqli_fetch_array($res)){
                ...
                $fout .= '<form id="category_'.$data["id"].'" method="POST">'
                        ...
                        . ' <input vr-control type="text" class="input" id="save_value_'.$data["id"].'" value="'.$data["value"].'" />
                            <input vr-control  id="button_save_value_'.$data["id"].'" type="button" class="btn small" value="'.lang("Save").'" onClick=\'
                        ...
                        . '<select vr-control id="select_'.$data["id"].'" class="input" name="action" onChange=\'
                            if(this.value=="1"){
                            ...
                            \'>'
                        . '<option vr-control id="option-action-'.$data["id"].'-0" selected disabled>'.lang("Select option").'</option>'
                        . '<option vr-control id="option-action-'.$data["id"].'-1" value="1">'.lang("Add value").'</option>'
                        . '<option vr-control id="option-action-'.$data["id"].'-2" value="2">'.lang("Edit property").'</option>';
                $query = 'SELECT * FROM `nodes_product_data` WHERE `cat_id` = "'.$data["id"].'"';
                $r = engine::mysql($query);
                $flag = 0;
                while($d = mysqli_fetch_array($r)){
                    ...
                    . '<input vr-control type="text" id="xcv_'.$d["id"].'" name="value" class="input" placeHolder="'.lang("New value").'" />';
                        if($data["id"]=="1"){
                            $fout .= '<input vr-control type="text" id="cat_url_'.$d["id"].'" name="value" class="input" placeHolder="URL" />';
                        }
                        $fout .= '<input vr-control id="cat_btn_'.$d["id"].'" type="button" class="btn small" value="'.lang("Add").'" onClick=\'
                        document.getElementById("category_id_'.$data["id"].'").value = "'.$data["id"].'";
                    ...
                    $fout .= '<li>
                            ...
                            '<input vr-control id="cat_btn_edit_'.$d["id"].'" type="button" class="btn small" value="'.lang("Edit").'" onClick=\'
                    ...
                    $fout .= '<input vr-control id="cat_btn_delete_'.$d["id"].'" type="button" class="btn small" value="'.lang("Delete").'" onClick=\'if(confirm("'.lang("Are you sure?").'")){
                    ...
                    $fout .= '</span>'
                            ...
                            . '<input vr-control type="text" name="value" id="cat_val_'.$d["id"].'" class="input" value="'.$d["value"].'" />';
                        if($data["id"]=="1"){
                            $fout .= '<input vr-control type="text" id="edit_cat_url_'.$d["id"].'" name="value" value="'.$d["url"].'" class="input" placeHolder="URL" />';
                        }
                        $fout .= '<input vr-control id="cat_btn_save_'.$d["id"].'" type="button" class="btn small" value="'.lang("Save").'"  onClick=\'
                        document.getElementById("category_id_'.$data["id"].'").value = "'.$d["id"].'";
                    ...
                    $fout .= '</select><ul class="pl15 lh2">
                        <li class="hidden" id="li_'.$data["id"].'">'
                    . '<input vr-control type="text" id="cv_'.$data["id"].'" name="value" class="input" placeHolder="'.lang("New value").'" />';
                        if($data["id"]=="1"){
                            $fout .= '<input vr-control type="text" id="cat_urlx_'.$data["id"].'" name="value" class="input" placeHolder="URL" />';
                        }
                        $fout .= '<input vr-control  id="cat_add_f_'.$data["id"].'" type="button" class="btn small" value="'.lang("Add").'" onClick=\'
                        document.getElementById("category_id_'.$data["id"].'").value = "'.$data["id"].'";
                        document.getElementById("category_action_'.$data["id"].'").value = "add";
            ...
            $fout .= '<br/></div>
                <input vr-control  id="cat_add_new_prop" type="button" class="btn w280 mb10" value="'.lang("Add new property").'" 
            ...
            $fout .= '
                <form method="POST" class="hidden" id="new_prop">
                    ...
                    <input vr-control id="input-new_property" type="text" name="new_property" placeHolder="'.lang("Value").'" class="input w280" /><br/><br/>
                    <input vr-control id="input-new_value" type="submit" class="btn w280" value="'.lang("Submit").'" /><br/><br/>
                </form>
            </div>
            <a vr-control id="back-to-products" href="'.$_SERVER["DIR"].'/admin/?mode=products"><input type="button" class="btn w280" value="'.lang("Back to products").'" /></a><br/>';
        }
            ...
            <tr>';
                $array = array(
                    ...
                    if($_SESSION["order"]==$order){
                        if($_SESSION["method"]=="ASC") $table .= '<a vr-control id="table-'.$order.'" class="link" href="#" onClick=\'document.getElementById("order").value = "'.$order.'"; document.getElementById("method").value = "DESC"; submit_search_form();\'>'.lang($value).'&nbsp;&uarr;</a>';
                        else $table .= '<a vr-control id="table-'.$order.'" class="link" href="#" onClick=\'document.getElementById("order").value = "'.$order.'"; document.getElementById("method").value = "ASC"; submit_search_form();\'>'.lang($value).'&nbsp;&darr;</a>';
                    }else $table .= '<a vr-control id="table-'.$order.'" class="link" href="#" onClick=\'document.getElementById("order").value = "'.$order.'"; document.getElementById("method").value = "ASC"; submit_search_form();\'>'.lang($value).'</a>';
                    $table .= '</th>';
                }
                $table .= '
            <th></th>
        ...
        while($data = mysqli_fetch_array($res)){
            ...
            $table .= '<tr>
                <td align=left valign=middle class="min-w150"><a vr-control id="product-'.$data.'" href="'.$_SERVER["DIR"].'/product/'.$data["id"].'" target="_blank">'.$data["title"].'</a></td>
            ...
            if($admin_access == 2){
                $table .= '
                        <form method="POST" id="edit_product_form_'.$data["id"].'" action="'.$_SERVER["DIR"].'/admin/?mode=products&action=edit&id='.$data["id"].'" >
                            ...
                            <select vr-control id="select-act-'.$id.'" name="act" class="input" onChange=\'document.getElementById("edit_product_form_'.$data["id"].'").submit();\'>
                                <option vr-control id="option-act-'.$id.'-0">'.lang("Choose action").'</option>
                                <option vr-control id="option-act-'.$id.'-1" value="1">'.lang("Edit item").'</option>';

                if($data["status"]) $table .= '<option vr-control id="option-act-'.$id.'-2" value="2">'.lang("Deactivate item").'</option>';
                else $table .= '<option vr-control id="option-act-'.$id.'-3" value="3">'.lang("Activate item").'</option>';
    ...
    ';
        ...
        if($admin_access == 2){
            $fout .= '<br/>
            <a id="list-new-item" href="'.$_SERVER["DIR"].'/admin/?mode=products&action=add"><input type="button" class="btn w280" value="'.lang("List new Item").'" ></a><br/><br/>'
            . '<a vr-control id="edit-properties" href="'.$_SERVER["DIR"].'/admin/?mode=products&action=edit"><input type="button" class="btn w280" value="'.lang("Edit Properties").'" ></a><br/>';
        }
    }
    return $fout;
}
