...
function print_image_rotator($site, $caption, $images) {
    engine::log('product.print_image_rotator('.$caption.')');
    try {
            ...
            <div class="pswp__scroll-wrap">
                ...
                <div class="pswp__ui pswp__ui--hidden">
                    <div class="pswp__top-bar">
                        ...
                        <button id="pswp-button-close" class="pswp__button pswp__button--close" title="'.engine::lang("Close").'"></button>
                        <button id="pswp-button-fs" class="pswp__button pswp__button--fs" title="'.engine::lang("Toggle fullscreen").'"></button>
                        <button id="pswp-button-zoom" class="pswp__button pswp__button--zoom" title="'.engine::lang("Zoom in/out").'"></button>
                    ...
                    <button id="pswp-button-prev" class="pswp__button pswp__button--arrow--left" title="'.engine::lang("Previous (arrow left)").'">
                    </button>
                    <button id="pswp-button-next" class="pswp__button pswp__button--arrow--right" title="'.engine::lang("Next (arrow right)").'">
                    </button>
        ...
        engine::throw('product.print_image_rotator('.$caption.')', $e);
    }
}
