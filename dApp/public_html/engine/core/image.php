...
function __construct($file) {
    ...
    try {
        ...
        engine::throw('image.__construct('.$file.')', $e);
    }
}
...
function resize($width = false, $height = false) {
    ...
    try {
        ...
        engine::throw('image.resize('.$width.', '.$height.')', $e);
    }
}
...
function crop($x0 = 0, $y0 = 0, $w = false, $h = false) {
    ...
    try {
        ...
        engine::throw('image.crop('.$x.', '.$y.', '.$w.', '.$h.')', $e);
    }
}
...
private function cropSave($x0, $y0, $w, $h) {
    ...
    try {
        ...
        engine::throw('image.cropSave('.$x.', '.$y.', '.$w.', '.$h.')', $e);
    }
}
...
function save($path = '', $fileName, $type = false, $rewrite = false, $quality = 95) {
    ...
    try {
        ...
        engine::throw('image.save('.$path.', '.$fileName.', '.$type.', '.$rewrite.', '.$quality.')', $e);
        return false;
    }
}
...
private function setType($file) {
    ...
    try {
        ...
        engine::throw('image.setType('.$file.')', $e);
        return false;
    }
}
...
private function getSizeByFramework($width, $height) {
    ...
    try {
        ...
        engine::throw('image.getSizeByFramework('.$width.', '.$height.')', $e);
    }
}
...
private function getSizeByWidth($width) {
    ...
    try {
        ...
        engine::throw('image.getSizeByWidth('.$width.')', $e);
    }
}
...
private function getSizeByHeight($height) {
    ...
    try {
        ...
        engine::throw('image.getSizeByHeight('.$height.')', $e);
    }
}
...
static function resize_image($src, $dest, $width, $height, $rgb = 0x1d1d1d, $quality = 95, $proportions = 0) {
    ...
    try {
        ...
        engine::throw('image::resize_image('.$src.', '.$dest.', '.$width.', '.$height.', '.$rgb.', '.$quality.', '.$proportions.')', $e);
        return false;
    }
}
...
static function upload_plan($src, $dest, $ext, $width = 600, $height = 600, $rgb = 0xffffff, $quality = 100, $proportions = 1) {
    ...
    try {
        ...
        engine::throw('image::upload_plan('.$src.', '.$dest.', '.$ext.', '.$width.', '.$height.', '.$rgb.', '.$quality.', '.$proportions.')', $e);
        return false;
    }
}
...
static function base64_to_jpg($base64_string, $output_file) {
    ...
    try {
        ...
        engine::throw('image::base64_to_jpg('.$output_file.')', $e);
        return false;
    }
}
}
