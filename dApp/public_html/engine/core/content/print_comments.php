...
function print_comment($id, $noreply = 0) {
    engine::log('content.print_comment('.$id.')');
    try {
        $fout = '';
        $fout1 = '';
        ...
        engine::throw('content.print_comment('.$id.')', $e);
    }
}

function print_comments($url) {
    engine::log('content.print_comments('.$url.')');
    try {
        $fout = '';
        $fout1 = '';
        ...
        engine::throw('content.print_comments('.$url.')', $e);
    }
}
