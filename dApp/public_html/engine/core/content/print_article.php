...
function print_article($site, $data) {
    engine::log('content.print_article('.$data["caption"].')');
    try {
        if (!empty($data["img"])) {
        ...
        <div class="clear"><br/></div>
        <a id="show-comments" onClick=\'$id("comments_block").style.display="block"; this.style.display="none";\'><button class="btn w280 mt15" >'.engine::lang("Show comments").'</button></a>
        <br/><br/>
        <div id="comments_block">
            <a name="comments"></a>
            <div class="tal pl10 fs21"><b>'.engine::lang("Latest comments").'</b></div>
            <br/><br/>
        ...
        engine::throw('content.print_article('.$data["caption"].')', $e);
    }
}
