...
static function email_template($text) {
    ...
    try {
        ...
        engine::throw('email::email_template('.$text.')', $e);
        return false;
    }
}
/**
...
static function bulk_mail($data) {
    ...
    try {
        ...
        engine::throw('email::bulk_mail('.$data.')', $e);
        return false;
    }
}
...
static function daily_report() {
    ...
    try {
        ...
        engine::throw('email::daily_report()', $e);
        return false;
    }
}
...
static function registration($email, $name) {
    ...
    try {
        ...
        return engine::send_mail($email, $_SERVER["configs"]["name"]."<no-reply@".$_SERVER["HTTP_HOST"].'>', $caption, email::email_template($body));
    } catch(Exception $e) {
        engine::throw('email::registration('.$email.', '.$name.')', $e);
        return false;
    }
}
...
static function confirmation($email, $name, $code) {
    ...
    $caption = engine::lang('Registration at').' '.$_SERVER["HTTP_HOST"];
        ...
        engine::throw('email::confirmation('.$email.', '.$name.')', $e);
        return false;
    }
}
...
static function restore_password($email, $new_pass, $code) {
    ...
    try {
        ...
        return engine::send_mail($user["email"], $_SERVER["configs"]["name"]."<no-reply@".$_SERVER["HTTP_HOST"].'>', $caption, email::email_template($body));
    } catch(Exception $e) {
        engine::throw('email::restore_password('.$email.')', $e);
        return false;
    }
}
...
static function new_comment($user_id, $url) {
    ...
    try {
        ...
        return engine::send_mail($_SERVER["configs"]["email"], $_SERVER["configs"]["name"]."<no-reply@".$_SERVER["HTTP_HOST"].'>', $caption, email::email_template($message));
    } catch(Exception $e) {
        engine::throw('email::new_comment('.$user_id.', '.$url.')', $e);
        return false;
    }
}
...
static function new_transaction($user_id, $amount) {
    ...
    try {
        ...
        engine::throw('email::new_transaction('.$user_id.', '.$amount.')', $e);
        return false;
    }
}
...
static function new_withdrawal($user_id, $amount, $wallet, $id) {
    ...
    try {
        ...
        return engine::send_mail($_SERVER["configs"]["email"], $_SERVER["configs"]["name"]."<no-reply@".$_SERVER["HTTP_HOST"].'>', $caption, email::email_template($body));
    } catch(Exception $e) {
        engine::throw('email::new_withdrawal('.$user_id.', '.$amount.', '.$wallet.', '.$id.')', $e);
        return false;
    }
}
...
static function finish_withdrawal($user_id) {
    ...
    try {
        ...
        engine::throw('email::finish_withdrawal('.$user_id.')', $e);
        return false;
    }
}
...
static function new_purchase($id) {
    ...
    try {
        ...
        engine::throw('email::new_purchase('.$id.')', $e);
        return false;
    }
}
...
static function shipping_confirmation($id) {
    ...
    try {
        ...
        engine::throw('email::shipping_confirmation('.$id.')', $e);
        return false;
    }
}
...
static function delivery_confirmation($id) {
    ...
    try {
        ...
        engine::throw('email::delivery_confirmation('.$id.')', $e);
        return false;
    }
}
}
