...
function print_panorama() {
    ...
    <!-- <div id="map_frame">
        ...
        <iframe sandbox="allow-same-origin allow-top-navigation allow-forms allow-scripts" src="/level.php?id=1" width=600 height=600></iframe>
    </div>
    <button class="map icon" id="map">
        <img id="map_icon" src="/img/vr/map.png" width="100%" onClick="document.panorama.showMap();" /> 
    </button>
    -->
