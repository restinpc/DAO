...
function print_panorama() {
    ...
    <div id="map_frame">
        ...
        <iframe sandbox="allow-same-origin allow-top-navigation allow-forms allow-scripts" style="zoom: 0.75" src="'.$_SERVER["DIR"].'/level.php?id=1" width=600 height=600></iframe>
    </div>
