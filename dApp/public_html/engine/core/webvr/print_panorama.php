    ...
    <div id="map_frame">
        ...
        <script>
            ...
            document.panorama.scaleMap = () => {
                let width = document.getElementById("panorama").clientWidth;
                let height = document.getElementById("panorama").clientHeight;
                let size = width > height ? height : width;
                let scale = size / 650;
                document.getElementById("map_iframe").style.scale = scale;
            }
