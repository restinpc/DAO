...
$_SERVER['PHP_SELF'] = '/files.php';
//Default Configuration
$CONFIG = '{"lang":"'.$_SESSION["Lang"].'","error_reporting":false,"show_hidden":false,"hide_Cols":false,"theme":"light"}';
...
function fm_get_translations($tr) {
    try {
        $content = @file_get_contents('res/translation.json');
        if($content !== FALSE) {
