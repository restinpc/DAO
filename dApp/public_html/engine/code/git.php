...
$content = engine::curl_get_query("http://git.nodes-tech.ru:3000/restinpc/DAO");
...
$content = preg_replace('#href="/#', 'target="_blank" href="http://git.nodes-tech.ru:3000/', $content);
