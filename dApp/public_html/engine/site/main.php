...
function main($site) {
    ...
    try {
        ...
        $site->title = "DAO";
        // $site->content .= engine::print_site_navigation(engine::lang("Project whitepaper"));
        if ($_SESSION["Lang"] == "ru") {
            $site->description = 'Цель проекта - построить сообщество, объект недвижимости и цифровую инфраструктуру для комфортного существования участников согласно принципам DAO (децентрализованной автономной организации).';
            $site->keywords = array(
                "DAO",
                "Mansion",
                "Особняк",
...
<div class="document980 article">
    ...
    <br/>
            ...
            $site->description = '项目目标是根据 DAO（去中心化自治组织）原则建立社区、别墅和数字基础设施，以确保参与者的舒适生活。';
            $site->keywords = array(
                "DAO",
                "Mansion",
                "別墅",
...
<div class="document980 article">
    ...
    <br/>
            ...
            $site->description = 'The goal of the project is to build a community, villa, and digital infrastructure for the comfortable existence of participants according to the principles of a Decentralized Autonomous Organization (DAO).';
            $site->keywords = array(
                "DAO",
                "Mansion",
                "Villa",
