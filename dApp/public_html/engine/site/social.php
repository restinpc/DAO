...
if (!empty($_GET[2])) {
    ...
    if ($_SESSION["Lang"] == "en") {
        ...
        $this->keywords = ["社交", "Telegram", "Web 3.0", "社區"];
    } else {
    ...
    if ($_SESSION["Lang"] == "en") {
        ...
        $this->keywords = ["社會", "憲法", "規則", "Web 3.0", "社區"];
    } else {
        $this->description = "Публичная внутренняя конституция с принципами и правилами сообщества";
        $this->keywords = ["Общество", "Конституция", "Web 3.0", "Сообщество"];
    }
    ...
    if ($_SESSION["Lang"] == "en") {
        ...
        $this->keywords = ["社交", "區塊鏈", "選舉", "Web 3.0", "社區"];
    } else {
    ...
    if ($_SESSION["Lang"] == "en") {
        ...
        $this->keywords = ["社交", "眾籌", "Web 3.0", "社區"];
    } else {
